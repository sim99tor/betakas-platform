        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ref = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeePct = table.Column<int>(type: "integer", nullable: false),
                    SprintNo = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PackageId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    ...
                    Testers = table.Column<int>(type: "integer", nullable: false),
                    ...
                    InvoiceNo = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Startup = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    ...
                    ExpertiseCategories = table.Column<List<string>>(type: "text[]", nullable: false),
                    ExpertiseOther = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: true),
                    Role = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    Status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    Iban = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    SubscriptionPlanId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fixes = table.Column<string>(type: "jsonb", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Url = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ProductCategory = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
                    Stage = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    FeedbackType = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TesterId = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    Status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    ...
                    DisputeOutcome = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    CashPaid = table.Column<decimal>(type: "numeric", nullable: true)
                },
                constraints: table =>
                {
